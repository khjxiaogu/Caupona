...
public class LoafBowlRenderer implements BlockEntityRenderer<BowlBlockEntity> {

	/**
	 * @param rendererDispatcherIn
	 */
	public LoafBowlRenderer(BlockEntityRendererProvider.Context rendererDispatcherIn) {
	}
